...
// // Si el contador está dentro del rango, mover el servo
// if (contador1 >= -30 && contador1 <= 30) {
//   myservo.write(contador1 + angulo_default);

//   // Si el ángulo medido está cerca de 0, registrar ese valor
//   if (angulo_medido[0] < 0.1 && angulo_medido[0] > -0.1) {
//     float angulo_cero_SERVO = contador1;
//   }
// } else {
//   // Si se pasa del rango, cambiar el sentido del barrido
...
//  if(contador1 < 30){
//   if(angulo_medido[0] < 0.1 && angulo_medido[0] > -0.1){
//     angulo_cero = contador1+angulo_default;
//   }
//   myservo.write(angulo_default + angulo_medido[0]);
//  }

  float mediciones[2] = {angulo_medido[0], medicion1};
