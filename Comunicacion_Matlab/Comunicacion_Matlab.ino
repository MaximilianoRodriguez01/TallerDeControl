...
void loop() {
  ...
  float aceleracion_X = a.acceleration.x;

  float aceleracion_Y = a.acceleration.y;

  float aceleracion_Z = a.acceleration.z;
  ...
  delay(500);
	...
	// Matlab send
  matlab_send(aceleracion_X,aceleracion_Y,aceleracion_Z);
  delay(1000);
}
